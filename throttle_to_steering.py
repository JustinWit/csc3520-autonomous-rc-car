...
def main(loadamodel=False):
    ...
    if loadamodel:
        model_throttle = load_model('models\\throttle_to_steering')
        ...
        model_throttle.save('models\\throttle_to_steering')
